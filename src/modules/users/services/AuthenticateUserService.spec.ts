...
describe('Authenticate User', () => {
    it('should be able to authenticate', async () => {
        ...
        const response =  await authenticateUsersService.execute({email:'saulo.medeiros@g4flex.com.br', password:'123456'});
    ...
    it('should be able to authenticate with non existing user', async () => {
        ...
        expect( authenticateUsersService.execute({email:'saulo.medeiros@g4flex.com.br', password:'123456'})
    ...
    it('should be able to authenticate with wrong password', async () => {
        ...
        expect( authenticateUsersService.execute({email:'saulo.medeiros@g4flex.com.br', password:'1236'})
        ).rejects.toBeInstanceOf(AppError);
